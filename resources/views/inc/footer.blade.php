    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-sm-6 col-md-3">
          <div class="footer-links">
            ...
            <div class="footer-link-list">
              ...
              <a href="{{ route('aboutUs') }}" class="footer-links">About Us</a>
        ...
        <div class="col-sm-6 col-md-3">
          <div class="footer-links">
            <br>
            <h3 class="footer-brand mb-2">JobSeeker</h3>
            <div class="footer-link-list">
              <div class="line-divider"></div>
              <a href="#" class="footer-links"><i class="fas fa-compass"></i> Newroad, Kathmandu-64400, Nepal</a>
              <a href="tel:98400001511" class="footer-links"><i class="fas fa-phone"></i> +977-984321789</a>
