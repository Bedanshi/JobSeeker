...
class AccountController extends Controller
{
    ...
    {
        $savedJobs = auth()->user()->savedJobs; // Assuming you have a relationship defined between User and SavedJob models

        return view('account.saved-job', compact('savedJobs'));
    }
    // ...

    public function appliedJobs()
    {
        $appliedJobs = auth()->user()->appliedJobs; // Assuming you have a relationship defined between User and AppliedJob models

        return view('account.applied', compact('appliedJobs'));
    }
